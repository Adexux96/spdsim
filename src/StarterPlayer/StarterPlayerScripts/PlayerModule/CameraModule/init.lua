...
function CameraModule.new()
	...
	self.activeTransparencyController = nil--TransparencyController.new()
	--_G.controller = self.activeTransparencyController -- set the global variable to read in the OTS cam
