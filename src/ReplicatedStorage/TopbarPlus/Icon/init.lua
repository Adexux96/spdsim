...
if Icon.isOldTopbar then
	...
	--Icon.modifyBaseTheme(require(themes.Default))
end
...
--[[
function Icon:setImageTransparency(transparency, iconState)
	self:modifyTheme({"IconImage", "ImageTransparency", imageId, iconState})
	return self
end
]]
